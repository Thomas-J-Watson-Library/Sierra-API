#/usr/bin/python
# file:   affiliations/standardize/doFix.py
...
# Gist:   Sets the variable field 'd' value to whatever is in
#         the text file todolist.txt
# Usage:  $python doFix.py
#
import json
import requests
import csv
...
# -------------------------------------------------------------
# Open the file of pending updates and set the value of field d
# -------------------------------------------------------------
DONECOUNT=0
...
for row in input_file:
    ...
    my_affiliation = str(row['AFF'])
    payload = {
        "varFields":
            [ 
            { "fieldTag": "d", "content": ""+my_affiliation+"" },
            ]
        }
