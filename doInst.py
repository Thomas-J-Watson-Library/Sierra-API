#/usr/bin/python
# file:   affiliations/standardize/doInst.py
...
# Gist:   For each record in todolist.txt this script sets the institution (fixed field 44) to
#         the code you list in this script 
# Usage:  $python doInst.py n
#         where n is the code to set     
import json
import requests
import csv
import base64
...
# -------------------------------------------------------------
# Open the file of pending updates and set the institution code
# -------------------------------------------------------------
DONECOUNT=0
input_file = csv.DictReader(open("todolist.txt"))
for row in input_file:
    ...
    if patrons_response.status_code == 204:
        ...
        print("****** ERROR ******* \n") 
print('Done updating the instition code. Now type python doNull.py')
